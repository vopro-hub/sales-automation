...
function create(sessionOrOption, catchQR, statusFind, onLoadingScreen, catchLinkCode, options, browserSessionToken) {
    return __awaiter(this, void 0, void 0, function () {
        var session, usingDeprecatedCreate, _a, onStreamModeChanged, onStreamInfoChanged, mergedOptions, logger, browser, page, client_1, isLogged, waitLoginPromise_1;
        var _this = this;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _a = sessionOrOption, onStreamModeChanged = _a.onStreamModeChanged, onStreamInfoChanged = _a.onStreamInfoChanged;
                ...
                case 3:
                    ...
                    if (!mergedOptions.browserWS &&
                        !((_b = mergedOptions.puppeteerOptions) === null || _b === void 0 ? void 0 : _b.userDataDir)) {
                ...
                case 8:
                    ...
                    if (onStreamModeChanged) {
                        client_1.onStreamModeChanged(onStreamModeChanged);
                    }
                    if (onStreamInfoChanged) {
                        client_1.onStreamInfoChanged(onStreamInfoChanged);
                    }
