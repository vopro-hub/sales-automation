...
var RetrieverLayer = /** @class */ (function (_super) {
     ...
     */
    RetrieverLayer.prototype.getMessagesFromRowId = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, helpers_1.evaluateAndReturn)(this.page, function (options) { return WPP.indexdb.getMessagesFromRowId(options); }, input)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
